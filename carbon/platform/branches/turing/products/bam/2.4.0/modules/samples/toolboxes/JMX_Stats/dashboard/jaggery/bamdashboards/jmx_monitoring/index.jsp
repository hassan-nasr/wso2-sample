...
<head>
    ...
    <title>BAM Dashboard - JMX Stats</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="container content-section">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-1" class="single-column-gadget"
                                                        src="gadgets/heapMem.jag?t=Now"></iframe>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-2" src="gadgets/nonHeapMem.jag?t=Now"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-3" src="gadgets/cpuUsage.jag?t=Now"
                                                            class="single-column-gadget"></iframe>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-4" src="gadgets/threads.jag?t=Now"
                                                            class="single-column-gadget"></iframe>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-5" src="gadgets/classes.jag?t=Now"
                                                            class="single-column-gadget"></iframe>
                        </div>
                    </div>
                <!--/row-->
