...
public class EventFlowTestCase extends CEPIntegrationTest {
    ...
    public void addEventFormatterTestScenario1() throws RemoteException, InterruptedException {
        ...
        eventFormatterAdminServiceClient.addWso2EventFormatterConfiguration("wso2eventformatter", "statisticsStream:1.0.0", "localEventSender", "wso2event", metaEventOutputPropertyConfigurationDtos, null, payloadEventOutputPropertyConfigurationDtos, eventFormatterPropertyDtos);
        Thread.sleep(1000);
