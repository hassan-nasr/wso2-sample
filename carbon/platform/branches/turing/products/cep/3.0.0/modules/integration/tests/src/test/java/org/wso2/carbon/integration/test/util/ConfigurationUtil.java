...
public class ConfigurationUtil {
    ...
    public void addEventStream() throws RemoteException, InterruptedException {
        ...
        EventStreamAttributeDto payloadDirection = new EventStreamAttributeDto();
        metaHost.setAttributeName("direction");
        metaHost.setAttributeType("STRING");
        EventStreamAttributeDto payloadFaultCount = new EventStreamAttributeDto();
        metaHost.setAttributeName("fault_count");
        metaHost.setAttributeType("INT");
        EventStreamAttributeDto[] metaData = new EventStreamAttributeDto[] {metaHost};
        EventStreamAttributeDto[] payloadData = new EventStreamAttributeDto[] {payloadDirection, payloadFaultCount};
        eventStreamManagerAdminServiceClient.addEventStream("org.wso2.sample.test","1.0.0", metaData, null, payloadData, "This is a test stream", "test");
    }
