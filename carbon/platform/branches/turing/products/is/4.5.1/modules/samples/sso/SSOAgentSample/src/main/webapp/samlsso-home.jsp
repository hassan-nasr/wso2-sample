...
<%
    ...
    if(request.getSession().getAttribute(
        ...
        if(((SSOAgentSessionBean) request.getSession().getAttribute(
            ...
            subject = ((SSOAgentSessionBean) request.getSession().getAttribute(
...
<div id="container">
    ...
    <div id="content-area">
        ...
        <div class="product-box">
            ...
            <a href="../avis.com/samlsso-home.jsp"> Avis.COM </a>
            <table>
                <%
                    Set<Map.Entry<String,String>> attributes = ((SSOAgentSessionBean)session.getAttribute(
                            SSOAgentConfigs.getSessionBeanName())).getSamlSSOAttributes().entrySet();
