...
Welcome to the WSO2 Elastic Load Balancer 2.1.0 release
...
The product is based on the revolutionary WSO2 Carbon framework. All the major 
features have been developed as pluggable Carbon components. WSO2 Elastic 
Load Balancer is a compact version doing the load balancing features of WSO2
...
1. Extract the wso2elb-2.1.0.zip and go to the extracted directory
2. Run the wso2server.sh|bat as appropriate
3. Configure the load balancer to manage the load across the instants to be balanced.

WSO2 ELB 2.1.0 distribution directory structure
===============================================
    ...
    - release-notes.html
	  Release information for WSO2 ELB 2.1.0
