...
cp $resorce_dir/lib/jenkins/org.wso2.carbon.appfactory.multitenant.jenkins-1.1.0.jar $BUILD_SERVER_AS_HOME/repository/components/dropins
...
cp $resorce_dir/lib/jenkins/org.wso2.carbon.appfactory.jenkinsext-1.1.0.jar $BUILD_SERVER_AS_HOME/lib/runtimes/jenkins/
