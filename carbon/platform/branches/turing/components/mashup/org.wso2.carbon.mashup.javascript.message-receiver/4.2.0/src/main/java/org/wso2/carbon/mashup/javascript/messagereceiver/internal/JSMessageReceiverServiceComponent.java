...
public class JSMessageReceiverServiceComponent {
    ...
    public void activate(ComponentContext componentContext) {
        ...
        try {
            RhinoSecurityController securityController = new RhinoSecurityController() {
                @Override
            ...
            JavaScriptEngineUtils.setEngine(new RhinoEngine(new CacheManager(null), new RhinoContextFactory(securityController) {
                @Override
                /**
