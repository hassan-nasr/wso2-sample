...
public class RegistryPersistenceManager {
    ...
    public EventingConfigData load(int tenantId) {
        ...
        try {
            ...
            String bumpBody = getConfigurationProperty(tenantId, MessageTracerConstants.ENABLE_DUMP_MESSAGE_BODY);

            if (enableTrace != null && bamUrl != null && bamUserName != null && bamPassword != null) {
                ...
                eventingConfigData.setDumpBodyEnable(Boolean.valueOf(bumpBody));
