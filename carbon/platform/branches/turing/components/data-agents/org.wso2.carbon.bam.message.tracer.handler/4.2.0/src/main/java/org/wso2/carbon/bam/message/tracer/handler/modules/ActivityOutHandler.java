...
public class ActivityOutHandler extends AbstractHandler {
    ...
    public InvocationResponse invoke(MessageContext messageContext) throws AxisFault {
        ...
        if (tenantID == -1) {
            ...
            Object tId = inMessageContext.getProperty(ActivityInHandler.TENANT_ID);
            if (tId != null) {
        ...
        if (eventingConfigData != null && eventingConfigData.isMessageTracingEnable()) {
            ...
            if (service == null || (SystemFilter.isFilteredOutService(service.getAxisServiceGroup()) && !MessageTracerConstants.SYNAPSE_SERVICE.equals(service.getName())) || service.isClientSide()) {
                ...
                try {
                    if (eventingConfigData.isDumpBodyEnable()) {
                        try {
                            ...
                            method.invoke(null, new Object[]{messageContext, false});
