...
import org.wso2.carbon.identity.oauth.tokenprocessor.PlainTextProcessor;
...
public class TokenMgtDAO {
    ...
    public TokenMgtDAO() {
        ...
        try {
            tokenPersistenceProcessor = OAuthServerConfiguration.getInstance().getTokenPersistenceProcessor();
    ...
    public void storeAuthorizationCode(String authzCode, String consumerKey, String callbackUrl,
        ...
        try {
            ...
            prepStmt.setString(1, tokenPersistenceProcessor.getProcessedToken(authzCode));
            prepStmt.setString(2, tokenPersistenceProcessor.getProcessedToken(consumerKey));
    ...
    public void storeAccessToken(String accessToken, String consumerKey,
        ...
        try {
            ...
            prepStmt.setString(1, tokenPersistenceProcessor.getProcessedToken(accessToken));
            if(accessTokenDO.getRefreshToken() != null){
                prepStmt.setString(2, tokenPersistenceProcessor.getProcessedToken(accessTokenDO.getRefreshToken()));
            } else {
                prepStmt.setString(2, accessTokenDO.getRefreshToken());
            }
            prepStmt.setString(3, tokenPersistenceProcessor.getProcessedToken(consumerKey));
    ...
    public OAuth2AccessTokenRespDTO getValidAccessTokenIfExist(String consumerKey, String userName,
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                accessToken = tokenPersistenceProcessor.getPreprocessedToken(resultSet.getString("ACCESS_TOKEN"));
                if(resultSet.getString("REFRESH_TOKEN") != null){
                    refreshToken = tokenPersistenceProcessor.getPreprocessedToken(resultSet.getString("REFRESH_TOKEN"));
                } else {
    ...
    public AuthzCodeDO validateAuthorizationCode(String consumerKey, String authorizationKey) throws IdentityOAuth2Exception {
        ...
        try {
            ...
            prepStmt.setString(1, tokenPersistenceProcessor.getProcessedToken(consumerKey));
            prepStmt.setString(2, tokenPersistenceProcessor.getProcessedToken(authorizationKey));
            resultSet = prepStmt.executeQuery();
    ...
    public RefreshTokenValidationDataDO validateRefreshToken(String consumerKey,
        ...
        try {
            ...
            if(refreshToken != null){
                prepStmt.setString(2, tokenPersistenceProcessor.getProcessedToken(refreshToken));
            } else {
            ...
            if (resultSet.next()) {
                validationDataDO.setAccessToken(tokenPersistenceProcessor.getPreprocessedToken(resultSet.getString(1)));
    ...
    public AccessTokenDO validateBearerToken(String accessToken)
        ...
        try {
            ...
            if (resultSet.next()) {
                String consumerKey = tokenPersistenceProcessor.getPreprocessedToken(resultSet.getString(1));
    ...
    public void revokeTokensByClient(String token, String consumerKey) throws IdentityOAuth2Exception {
        ...
        try {
            ...
            ps.setString(3, tokenPersistenceProcessor.getProcessedToken(token));
            ps.setString(4, tokenPersistenceProcessor.getProcessedToken(consumerKey));
    ...
    private void revokeTokenForApp(Connection dbConnection, String consumerKey, String authzUser, String accessTokenStoreTable)
        ...
        if(accessTokenRespDTO != null){
            ...
            ps.setString(1, OAuth2Constants.TokenStates.TOKEN_STATE_REVOKED);
            ps.setString(2, UUID.randomUUID().toString());
            ps.setString(3, tokenPersistenceProcessor.getProcessedToken(consumerKey));
            ps.setString(4, authzUser);
            ps.setString(5, tokenPersistenceProcessor.getProcessedToken(accessTokenRespDTO.getAccessToken()));
            int count = ps.executeUpdate();
            if (log.isDebugEnabled()) {
                log.debug("Number of rows being updated : " + count);
            }
    ...
    public OAuthAppDO[] getAppsAuthorizedByUser(String authzUser) throws IdentityOAuth2Exception {
        ...
        try {
            ...
            while (rs.next()) {
                String consumerKey = tokenPersistenceProcessor.getPreprocessedToken(rs.getString(1));
     ...
     * @throws IdentityOAuth2Exception
     */
    public String getAccessTokenState(String consumerKey, String authorizedUser, String userType) throws IdentityOAuth2Exception {
