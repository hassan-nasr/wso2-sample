...
public class OAuthAppDAO {
    ...
    public void addOAuthApplication(OAuthAppDO consumerAppDO) throws IdentityOAuthAdminException {
        ...
        if (!isDuplicateApplication(consumerAppDO.getUserName(), consumerAppDO.getTenantId(), consumerAppDO)) {
            try {
                ...
                prepStmt.setString(1, tokenPersistenceProcessor.getProcessedToken(consumerAppDO.getOauthConsumerKey()));
                prepStmt.setString(2, tokenPersistenceProcessor.getProcessedToken(consumerAppDO.getOauthConsumerSecret()));
        ...
        try {
            ...
            while (rSet.next()) {
                if (rSet.getString(3) != null && rSet.getString(3).length() > 0) {
                    ...
                    oauthApp.setOauthConsumerKey(tokenPersistenceProcessor.getPreprocessedToken(rSet.getString(1)));
                    oauthApp.setOauthConsumerSecret(tokenPersistenceProcessor.getPreprocessedToken(rSet.getString(2)));
        ...
        try {
            ...
            while (rSet.next()) {
                ...
                if (rSet.getString(4) != null && rSet.getString(4).length() > 0) {
                    ...
                    oauthApp.setOauthConsumerSecret(tokenPersistenceProcessor.getPreprocessedToken(rSet.getString(1)));
    ...
    public void updateConsumerApplication(OAuthAppDO oauthAppDO) throws IdentityOAuthAdminException {
        ...
        try {
            ...
            prepStmt.setString(4, tokenPersistenceProcessor.getProcessedToken(oauthAppDO.getOauthConsumerKey()));
            prepStmt.setString(5, tokenPersistenceProcessor.getProcessedToken(oauthAppDO.getOauthConsumerSecret()));
