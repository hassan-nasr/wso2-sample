...
public class DefaultAttributeFinder extends AbstractPIPAttributeFinder {
	...
	public Set<String> getAttributeValues(String subjectId, String resourceId, String actionId,
		...
		if (UserCoreConstants.ClaimTypeURIs.ROLE.equals(attributeId)) {
			...
			String[] roles = CarbonContext.getCurrentContext().getUserRealm().getUserStoreManager()
			...
			String claimValue = CarbonContext.getCurrentContext().getUserRealm().
	...
	public Set<String> getSupportedAttributes() {
        try{
            ClaimManager claimManager = CarbonContext.getCurrentContext().getUserRealm().getClaimManager();
