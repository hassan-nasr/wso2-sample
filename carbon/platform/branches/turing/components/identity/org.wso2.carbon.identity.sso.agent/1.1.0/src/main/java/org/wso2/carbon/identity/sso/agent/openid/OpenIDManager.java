...
public class OpenIDManager {
    ...
    public String doOpenIDLogin(HttpServletRequest request, HttpServletResponse response) throws SSOAgentException {
        ...
        try {
            ...
            SSOAgentSessionBean sessionBean = null;
            if(request.getSession().getAttribute(SSOAgentConfigs.getSessionBeanName()) != null){
                sessionBean = (SSOAgentSessionBean)request.getSession().getAttribute(SSOAgentConfigs.getSessionBeanName());
            } else {
                sessionBean = new SSOAgentSessionBean();
            }
            sessionBean.setDiscoveryInformation(discovered); // set the subject
    ...
    public void processOpenIDLoginResponse(HttpServletRequest request, HttpServletResponse response) throws SSOAgentException{
        ...
        try {
            ...
            SSOAgentSessionBean ssoAgentSessionBean = (SSOAgentSessionBean)request.getSession().getAttribute(
            ...
            DiscoveryInformation discovered = ssoAgentSessionBean.getDiscoveryInformation();
            ...
            if (verified != null) {
                ...
                ssoAgentSessionBean.setClaimedId(authSuccess.getIdentity());
                ...
                if (authSuccess.hasExtension(AxMessage.OPENID_NS_AX)) {
                    ...
                    ssoAgentSessionBean.setOpenIdAttributes(attributesMap);
                }
