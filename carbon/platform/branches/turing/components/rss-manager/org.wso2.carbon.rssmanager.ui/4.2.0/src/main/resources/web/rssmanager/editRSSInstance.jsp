...
<fmt:bundle basename="org.wso2.carbon.rssmanager.ui.i18n.Resources">
    ...
    <%
        ...
        try {
            ...
            rssIns = client.getRSSInstance(ctx);
        } catch (Exception e) {
                            ...
                            <table class="normal">
                                ...
                                <tr>
                                    ...
                                    <td><label>
                                        <select name="databaseEngine" id="databaseEngine"
                                            ...
                                            <%
                                                instanceType = RSSManagerHelper.getDatabasePrefix(rssIns.getDataSourceConfig().getUrl().toLowerCase());
                                ...
                                <tr>
                                    <td align="left"><fmt:message
                                            ...
                                            color='red'>*</font></td>
                                    <td><input value="<%=rssIns.getDataSourceConfig().getUrl()%>" id="serverUrl"
                                               name="serverUrl"
