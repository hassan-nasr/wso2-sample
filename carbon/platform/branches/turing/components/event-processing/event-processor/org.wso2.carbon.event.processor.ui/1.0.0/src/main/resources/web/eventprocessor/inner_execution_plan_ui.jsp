...
<tr>
    ...
    <td>
        <table>
            ...
            <td><select id="importedStreamId" onchange="createImportedStreamDefinition(this)"
    ...
    <td>
        <table id="addExportedStreams" class="normal">
            ...
            <tr>
                ...
                <td><select id="exportedStreamId" onchange="createExportedStreamDefinition(this)"
                ...
                <td>
                <td><select id="eventFormatter" onchange="promptEventFormatterCreation(this)"
...
<tr>
    <td class="leftCol-med">
        <fmt:message key="advanced.mapping"/>
    </td>
    <td>
        <table id="eventFormatterSelectTable" class="normal">
            <tbody>
            <tr>
            </tr>
            </tbody>
