...
public interface EventProcessorService {
     ...
     */
    boolean validateSiddhiQueries(String[] inputStreamDefinitions, String queryExpressions) throws
             SiddhiPraserException;

    /**
     * Fetches all the streams imported and exported by the Siddhi engine for the given set of queries.
     * @param inputStreamDefinitions
     * @param queryExpressions
     * @return
     * @throws ExecutionPlanConfigurationException
     * @throws SiddhiPraserException
     */
    List<StreamDefinition> getSiddhiStreams(String[] inputStreamDefinitions, String queryExpressions) throws
             SiddhiPraserException;
}
