...
public class EventBuilderConfigurationFileSystemInvoker {
    ...
    public static void save(
            OMElement eventBuilderConfiguration,
            String fileName, AxisConfiguration axisConfiguration)
            throws EventBuilderConfigurationException {
        save(eventBuilderConfiguration.toString(), fileName, axisConfiguration);
    }

    public static void save(String eventBuilderConfigXml, String fileName, AxisConfiguration axisConfiguration) throws EventBuilderConfigurationException {
