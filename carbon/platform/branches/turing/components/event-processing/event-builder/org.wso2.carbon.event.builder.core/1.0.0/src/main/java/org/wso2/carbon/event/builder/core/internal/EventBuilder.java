...
public class EventBuilder {
        ...
        if (this.eventBuilderConfiguration != null) {
            ...
            if (this.inputMapper != null) {
                if (customMappingEnabled) {
                    try {
                        this.exportedStreamDefinition = new StreamDefinition(eventBuilderConfiguration.getToStreamName(), eventBuilderConfiguration.getToStreamVersion());
                        EventBuilderUtil.addAttributesToStreamDefinition(this.exportedStreamDefinition, this.inputMapper.getOutputAttributes());
                    } catch (MalformedStreamDefinitionException e) {
                        throw new EventBuilderConfigurationException("Error creating the exported stream definition : " + e.getMessage(), e);
                    }
                } else {
            ...
            if (traceEnabled) {
                ...
                this.afterTracerPrefix = "TenantId=" + tenantId + " : " + EventBuilderConstants.EVENT_BUILDER + " : "
                        + eventBuilderConfiguration.getEventBuilderName() + ", after processing " + System.getProperty("line.separator");
            }
        }
    }
    ...
    protected void defineEventStream(Object definition) throws EventBuilderConfigurationException {
        ...
        if (definition instanceof StreamDefinition) {
            ...
            if (!customMappingEnabled) {
                if (EventBuilderUtil.getStreamIdFrom(this.eventBuilderConfiguration).equals(inputStreamDefinition.getStreamId())) {
