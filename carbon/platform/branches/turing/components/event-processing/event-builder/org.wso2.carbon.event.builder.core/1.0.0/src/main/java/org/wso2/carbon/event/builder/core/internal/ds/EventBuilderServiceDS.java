...
import org.wso2.carbon.event.builder.core.EventStreamListenerImpl;
...
public class EventBuilderServiceDS {
    ...
    protected void activate(ComponentContext context) {
        try {
            ...
            EventBuilderServiceValueHolder.getEventStreamService().registerPassthroughReceiverConfigurator(EventBuilderServiceValueHolder.getCarbonEventBuilderService());
