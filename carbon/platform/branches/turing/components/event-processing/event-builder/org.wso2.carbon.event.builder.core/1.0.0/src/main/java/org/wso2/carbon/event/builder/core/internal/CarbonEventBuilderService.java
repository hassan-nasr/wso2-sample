...
public class CarbonEventBuilderService implements EventBuilderService, EventReceiver,PassthroughReceiverConfigurator {
    ...
    public void activateInactiveEventBuilderConfigurations(String eventAdaptorName,
                                                           int tenantId)
            throws EventBuilderConfigurationException {
    ...
    public void activateInactiveEventBuilderConfigurations(int tenantId,
                                                           String streamNameWithVersion
    ) throws EventBuilderConfigurationException {
        List<EventBuilderConfigurationFile> fileList = new ArrayList<EventBuilderConfigurationFile>();
        ...
        if (tenantSpecificEventBuilderConfigFileMap != null && tenantSpecificEventBuilderConfigFileMap.size() > 0) {
            ...
            if (eventBuilderConfigurationFiles != null) {
                for (EventBuilderConfigurationFile eventBuilderConfigurationFile : eventBuilderConfigurationFiles) {
                    if ((eventBuilderConfigurationFile.getDeploymentStatus().equals(EventBuilderConfigurationFile.DeploymentStatus.WAITING_FOR_STREAM_DEPENDENCY)) && eventBuilderConfigurationFile.getDependency().equalsIgnoreCase(streamNameWithVersion)) {
                        fileList.add(eventBuilderConfigurationFile);
                    }
                }
            }
    ...
    public void deactivateActiveEventBuilderConfigurations(
            int tenantId, String streamNameWithVersion)
            throws EventBuilderConfigurationException {
        ...
        if (tenantSpecificEventBuilderMap != null && tenantSpecificEventBuilderMap.size() > 0) {
            ...
            if (eventBuilderMap != null) {
                for (List<EventBuilder> eventBuilderList : eventBuilderMap.values()) {
                    for (EventBuilder eventBuilder : eventBuilderList) {
                        String stream = eventBuilder.getEventBuilderConfiguration().getInputStreamConfiguration().getInputEventAdaptorMessageConfiguration().getInputMessageProperties().get(EventBuilderConstants.ADAPTOR_MESSAGE_STREAM_NAME) + EventBuilderConstants.STREAM_NAME_VER_DELIMITER + eventBuilder.getEventBuilderConfiguration().getInputStreamConfiguration().getInputEventAdaptorMessageConfiguration().getInputMessageProperties().get(EventBuilderConstants.ADAPTOR_MESSAGE_STREAM_VERSION);
    ...
    private String getFileName(int tenantId, String eventBuilderName) {
        ...
        if (tenantSpecificEventBuilderConfigFileMap.size() > 0) {
            ...
            if (eventBuilderConfigurationFiles != null) {
                for (EventBuilderConfigurationFile eventBuilderConfigurationFile : eventBuilderConfigurationFiles) {
                    if ((eventBuilderConfigurationFile.getEventBuilderName().equals(eventBuilderName)) && eventBuilderConfigurationFile.getDeploymentStatus().equals(EventBuilderConfigurationFile.DeploymentStatus.DEPLOYED)) {
