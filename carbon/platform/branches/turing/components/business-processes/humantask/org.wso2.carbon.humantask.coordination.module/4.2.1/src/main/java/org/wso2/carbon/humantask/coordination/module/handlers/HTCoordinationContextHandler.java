...
public class HTCoordinationContextHandler extends AbstractHandler implements Handler {
    ...
    private static  HumanTaskServerConfiguration serverConfig = HTCoordinationModuleContentHolder.getInstance().getHtServer().getServerConfig();
    ...
    public InvocationResponse invoke(MessageContext messageContext) throws AxisFault {
        ...
        if(!serverConfig.isTaskRegistrationEnabled())
        {
