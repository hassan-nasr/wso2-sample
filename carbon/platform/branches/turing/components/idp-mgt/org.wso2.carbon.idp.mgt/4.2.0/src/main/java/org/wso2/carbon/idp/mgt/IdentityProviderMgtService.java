...
public class IdentityProviderMgtService {
    ...
    public TrustedIdPDTO getTenantIdP(String idPName) throws IdentityProviderMgtException {
        ...
        if(trustedIdPDO != null){
            ...
            trustedIdPDTO.setTokenEPAlias(trustedIdPDO.getTokenEPAlias());
        }
    ...
    public void updateTenantIdP(TrustedIdPDTO oldTrustedIdP, TrustedIdPDTO newTrustedIdP) throws IdentityProviderMgtException {
        ...
        oldTrustedIdPDO.setTokenEPAlias(oldTrustedIdP.getTokenEPAlias());
        ...
        if(newTrustedIdP.getTokenEPAlias() == null || newTrustedIdP.getTokenEPAlias().equals("")){
            String msg = "Invalid arguments: OAuth2 Token Endpoint name cannot be \'NULL\' or empty";
            log.error(msg);
            throw new IdentityProviderMgtException(msg);
        }
        newTrustedIdPDO.setTokenEPAlias(newTrustedIdP.getTokenEPAlias());
    ...
    private void doAddIdP(TrustedIdPDTO trustedIdP, int tenantId, String tenantDomain) throws IdentityProviderMgtException {
        ...
        if(trustedIdP.getTokenEPAlias() == null || trustedIdP.getTokenEPAlias().equals("")){
            String msg = "Invalid arguments: OAuth2 Token Endpoint name cannot be \'NULL\' or empty";
            log.error(msg);
            throw new IdentityProviderMgtException(msg);
        }
        trustedIdPDO.setTokenEPAlias(trustedIdP.getTokenEPAlias());
